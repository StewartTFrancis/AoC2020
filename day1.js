...
function p2()
{
    ...
    {
        if(nums.has(targetNum - (input[i] + input[j])))
        {   
            console.log((targetNum - (input[i] + input[j])) * input[i] * input[j]);
            return;
        }
    }
}
